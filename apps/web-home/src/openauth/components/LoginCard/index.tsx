import { useLogInWithDiscord, useLogInWithEthereum, useLogInWithGithub, useLogInWithGoogle, useLogInWithHuggingface, useLogInWithTikTok, useOpenAuth } from '@open-auth/sdk-react'
import { IconBrandDiscord, IconBrandGithub, IconBrandGoogle, IconBrandTelegram, IconBrandTiktok, IconCurrencyEthereum, IconLoader2, IconMoodSmileBeam, IconUser } from '@tabler/icons-react'
